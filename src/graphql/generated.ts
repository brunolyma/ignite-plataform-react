...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', title: string, slug: string, availableAt?: any | null, id: string, lessonType: LessonType }> };
